...
The following is a more detailed overview of how I drafted developer guide documentation for this feature. Besides the developer guide, I left comments on **customer-facing error messages in Java source code** and **[worked on UI text](/docs/content-design/ecs-ebs-integration-ui.md)**.
...
- The PDF version is a point-in-time snapshot of docs from when I last owned ECS documentation. The web version is the most up-to-date. There may be differences between the PDF and web versions.
