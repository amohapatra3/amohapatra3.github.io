...
For more information about AWS RAM, see [What is AWS Resource Access Manager?](https://docs.aws.amazon.com/ram/latest/userguide/what-is.html)

For more information about Amazon ECS Service Connect, see [Use Service Connect to connect Amazon ECS services with short names](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/service-connect.html).
...
3. I then drafted my updates. I was able to **find a cross-service integration XML template for integrations with RAM**. I used that as a base for my chapter in the Cloud Map developer guide, making adjustments specific to this launch such as mentioning the new API parameters. Documentation updates for the AWS RAM developer guide depended on AWS Cloud Map, so I **helped the technical writer for AWS RAM with information needed for their updates**. I **provided feedback and facilitated communications between the RAM writer and the tech lead for Cloud Map**.
