...
- Examples that capture basic uses and give a high-level overview of what requests and responses look like
...
The `GetServiceAttributes` action is used to retrieve attributes associated with an AWS Cloud Map service. I had to write descriptions for the action and its request parameter, response element, and errors. I also created a couple sample API call examples.
