...
Amazon Web Services (AWS) developer guides are large, and with regular product releases, writers can neglect information architecture. When an organizational goal was announced in 2024 involving improvements to information architecture, I was excited to contribute. I figured I'd learn a lot as an early career writer.

## Challenge

In 2024, the content strategy team within the AWS documentation org identified recurring issues based on customer feedback across several AWS developer guides. Topics were long and not very easy to read. Titles were not as specific as they could be.
